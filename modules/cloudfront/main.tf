...
# bucket url "http://uwc.app.fabian-portfolio.net.s3-website.af-south-1.amazonaws.com"
# locals {
...
# }
  ...
  # 1) Create CloudFront Origin Access Control fro s3 bucket
  resource "aws_cloudfront_origin_access_control" "oac" {
    name                 = "s3 bucket origin access"
