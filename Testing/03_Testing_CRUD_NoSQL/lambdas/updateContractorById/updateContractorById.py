...
table = dynamodb.Table("crud-nosql-app-contractor-table")
...
def lambda_handler(event, context):
    try:
        contractor_uuid = event.get("pathParameters", {}).get("id")
        ...
        return _response(200, {"message": "Contractor updated successfully", "updated_fields": update_fields})
