...
# Allowed fields to update (correct this for a job request and not an asset)
REQUIRED_FIELDS = [
    "description",
    "assetID",
    "condition",
...
def lambda_handler(event, context):
    try:
        ...
        return _response(200, {"message": "Job Request updated successfully", "updated_fields": update_fields})
